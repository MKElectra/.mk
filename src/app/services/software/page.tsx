...
export const metadata: Metadata = {
  title: "Software Engineering & Enterprise Web Solutions | MK Electra",
  description:
    "Custom web applications, mobile apps, SaaS development, telemetry dashboards, REST APIs, and enterprise cloud architecture engineered by MK Electra.",
};

export default function SoftwareServicePage() {
  const division = CORE_DIVISIONS.find((d) => d.id === "software")!;
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center max-w-4xl mx-auto">
          <div className="inline-flex items-center gap-2 mb-4">
            <span className="px-3 py-1 text-xs font-mono font-bold rounded-full bg-brand-500/20 text-cyan-300 border border-cyan-400/40 uppercase">
              DIVISION {division.number} — SOFTWARE
            </span>
          </div>
      ...
      <section className="py-20 bg-navy-900 border-b border-steel-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <SectionHeading
            ...
            kicker="FULL-STACK CAPABILITIES"
            title="Digital Solutions Built for Business Scale"
            subtitle="Explore our comprehensive software engineering services spanning frontends, microservices, mobile apps, and industrial telemetry."
            align="center"
          />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-12">
            {division.services.map((srv, idx) => (
              <div
                key={idx}
                className="p-8 rounded-2xl bg-navy-950 border border-steel-800 hover:border-brand-500/40 transition-all corner-crosshairs shadow-xl"
              >
      ...
      <section className="py-20 bg-navy-950 border-b border-steel-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <SectionHeading
            ...
            kicker="PROVEN FRAMEWORKS"
            title="Modern, Maintainable & Secure Technologies"
            subtitle="We build on enterprise-grade languages, frameworks, and databases with high performance and strong developer ecosystems."
            align="center"
          />
